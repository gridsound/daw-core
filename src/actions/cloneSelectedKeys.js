...
function DAWCoreActions_cloneSelectedKeys( daw, patId, keyIds, whenIncr ) {
	...
	const dur = DAWCoreActionsCommon_calcNewKeysDuration( daw, pat.keys, keysObj );
	...
	DAWCoreActionsCommon_updatePatternDuration( daw, obj, patId, dur );
	return [
		obj,
